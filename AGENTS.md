...
* stencil.lock: Lockfile for Stencil which also declares which files in the repository are managed, and which module manages it. Third party generated files are not cataloged.
